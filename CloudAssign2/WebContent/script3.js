$(document).ready(function(){
   ...
   $.ajax({
      ...
      dataType:"json",
      async:true,
      url:"http://sri.sytes.net:8080/CloudAssign2/rest/service/forecast/"+date,
      ...
      dataType:"json",
      async:true,
      url:"http://sri.sytes.net:8080/CloudAssign2/rest/service/forecast5/"+date,
      success:function(data){ 
...
Highcharts.chart('container', {
    ...
    title: {
        text: ' API Forecast Temperature-(Bonus Forecast)'
    },
    subtitle: {
